...
public class ReportFAHarian {
    ...
    @SerializedName("AfdelingCode")
    @Expose
    private String afdelingCode;
    @SerializedName("AfdelingDesc")
    @Expose
